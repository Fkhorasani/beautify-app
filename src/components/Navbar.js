...
import { ReactComponent as About } from "images/Navbar/About.svg";
...
export default class Navbar extends Component {
  ...
  render() {
    const navbarItems = [
      ...
      { path: RouteConstant.ABOUT, icon: <About />, name: "About Us" },
        ...
        >
          <div className="navbar">
            ...
            <ul className="navbar__group">
              {navbarItems.slice(0, 5).map(({ path, icon, name }, index) => {
                return (
                  <li
                    key={index}
                    onClick={() => {
            ...
            <ul className="navbar__group">
              ...
              {navbarItems.slice(5, 8).map(({ path, icon, name }, index) => {
                return (
                  <li
                    key={index + 4}
                    onClick={() => {
